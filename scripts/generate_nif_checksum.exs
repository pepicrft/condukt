# Generates `checksum-Elixir.Condukt.Bashkit.NIF.exs` from prebuilt NIF
# artifact tarballs. Used by the release workflow after the NIF build
# matrix has produced one tarball per {target, NIF version} pair.
#
# Usage: elixir scripts/generate_nif_checksum.exs <artifacts_dir>
#
...
[artifacts_dir] = System.argv()

unless File.dir?(artifacts_dir) do
  IO.puts(:stderr, "artifacts directory not found: #{artifacts_dir}")
  System.halt(1)
end

output_file = "checksum-Elixir.Condukt.Bashkit.NIF.exs"
