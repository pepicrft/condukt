...
The new abstraction is in the latest release. If you are not using Condukt yet, the [getting started guide](https://github.com/tuist/condukt/blob/main/guides/getting_started.md) is a good place to start. If you have an opinion about what an adapter for Daytona, E2B, or Kubernetes should look like before we ship it, we would love to hear it.
